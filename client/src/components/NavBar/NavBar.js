...
// Apparently this is a 'styled component'
// I have no idea what 'theme' is
// Update: 'theme' is kinda like a react prop
...
// Above code generated by copilot
    ...
    <Grid container sx={{ fontFamily: 'Montserrat', backgroundColor: '#353b48', padding: 1, }}>
      ...
      <Grid xs={8} container>
        ...
        <Grid xs={12} container sx={{ backgroundColor: '#2f3640' }}>
          ...
          <Grid xs={2}>
            <NavLink to="/fave" style={({ isActive }) => isActive ? activeStyle : undefined } className={navbar.navLinkItem}><FavoriteIcon /><span>Habits</span></NavLink>
          </Grid>
          <Grid xs={2}>
